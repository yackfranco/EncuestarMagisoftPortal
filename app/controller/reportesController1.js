    ...
    $scope.reporteexcelgeneral = function () {
        if (gfechainicial == "") {
            ...
            if (gfechafinal == "") {
                ...
                $scope.reporteexcelgeneral = function () {
                    $http.get($urlBase + "reportegeneral.php?gfechainicial=" + gfechainicial + "& gfechafinal=" + gfechafinal + "& gidciudad=" + gidciudad + "& gIdSede=" + gIdSede + "& gIdUsuario=" + gIdUsuario)
    ...
    $scope.reportePDFgeneral = function () {
        if (gfechainicial == "") {
            ...
            if (gfechafinal == "") {
                ...
                $scope.reportePDFgeneral = function () {
                    $http.get($urlBase + "ReporteGeneralPDF.php?gfechainicial=" + gfechainicial + "& gfechafinal=" + gfechafinal + "& gidciudad=" + gidciudad + "& gIdSede=" + gIdSede + "& gIdUsuario=" + gIdUsuario)
                        .then(function (response) {
                            /*
                            if (response.data.respuesta == "Enviado Correctamente") {
                                $('#modalDescarga').modal('show');
    ...
    $scope.reporteexcelgeneralDetallado = function () {
        if (gfechainicial == "") {
            ...
            if (gfechafinal == "") {
                ...
                $scope.reporteexcelgeneralDetallado = function () {
                    $http.get($urlBase + "reportegeneral.php?gfechainicial=" + gfechainicial + "& gfechafinal=" + gfechafinal + "& gidciudad=" + gidciudad + "& gIdSede=" + gIdSede + "& gIdUsuario=" + gIdUsuario + "& gPregunta=")
                        .then(function (response) {
                            /*
                            if (response.data.respuesta == "Enviado Correctamente") {
                                $('#modalDescarga').modal('show');
    ...
    $scope.reporteexcelgeneralDetallado = function () {
        if (dfechainicial == "") {
            ...
            if (dfechafinal == "") {
                ...
                $scope.reporteexcelgeneralDetallado = function () {
                    $http.get($urlBase + "reportegeneralDetalle.php?gfechainicial=" + dfechainicial + "& gfechafinal=" + dfechafinal + "& gidciudad=" + didciudad + "& gIdSede=" + dIdSede + "& gIdUsuario=" + dIdUsuario + "& gPregunta=" + dIdPregunta)
                        .then(function (response) {
                            if (response.data.respuesta == "Enviado Correctamente") {
                                $('#modalDescarga').modal('show');
                                $scope.MostrarDescarga = true;
    ...
    $scope.reporteexcelgeneralDetalladoPDF = function () {
        if (dfechainicial == "") {
            ...
            if (dfechafinal == "") {
                ...
                $scope.reporteexcelgeneralDetalladoPDF = function () {
                    $http.get($urlBase + "reportegeneralDetallePDF.php?gfechainicial=" + dfechainicial + "& gfechafinal=" + dfechafinal + "& gidciudad=" + didciudad + "& gIdSede=" + dIdSede + "& gIdUsuario=" + dIdUsuario + "& gPregunta=" + dIdPregunta)
                        .then(function (response) {
                            if (response.data.respuesta == "Enviado Correctamente") {
                                $('#modalDescarga').modal('show');
                                $scope.MostrarDescarga = true;
    ...
    $scope.reportegeneralDetalladoCSV = function () {
        if (dfechainicial == "") {
            ...
            if (dfechafinal == "") {
                ...
                $scope.reportegeneralDetalladoCSV = function () {
                    $http.get($urlBase + "reporteDetalleCSV.php?gfechainicial=" + dfechainicial + "& gfechafinal=" + dfechafinal + "& gidciudad=" + didciudad + "& gIdSede=" + dIdSede + "& gIdUsuario=" + dIdUsuario + "& gPregunta=" + dIdPregunta)
                        .then(function (response) {
                            if (response.data.respuesta == "Enviado Correctamente") {
                                $('#modalDescarga').modal('show');
                                $scope.MostrarDescarga = true;
    ...
    $scope.reportegeneralDetalladoHTML = function () {
        if (dfechainicial == "") {
            ...
            if (dfechafinal == "") {
                ...
                $scope.reportegeneralDetalladoHTML = function () {
                    $http.get($urlBase + "ReporteDetalladoHTML.php?gfechainicial=" + dfechainicial + "& gfechafinal=" + dfechafinal + "& gidciudad=" + didciudad + "& gIdSede=" + dIdSede + "& gIdUsuario=" + dIdUsuario + "& gPregunta=" + dIdPregunta)
                        .then(function (response) {
                            if (response.data.respuesta == "Enviado Correctamente") {
                                $('#modalDescarga').modal('show');
                                $scope.MostrarDescarga = true;
