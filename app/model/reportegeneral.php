...
if ($fechainical != null && $fechafinal != null) {
    $concatF1F2 = " WHERE (calificacion.FechaCalif >= '$fechainical 00:00:00' AND calificacion.FechaCalif <= '$fechafinal 23:59:59') and datosempresa.idempresa = $IdEmpresa ";
    $consultainicial = $consultainicial . $concatF1F2;
    $consultainicial2 = $consultainicial2 . $concatF1F2;
}
if ($fechainical != null && $fechafinal == null) {
    $concatF1F2 = " WHERE (calificacion.FechaCalif >= '$fechainical 00:00:00' AND calificacion.FechaCalif <= '$fechainical 23:59:59') and datosempresa.idempresa = $IdEmpresa ";
    $consultainicial = $consultainicial . $concatF1F2;
    $consultainicial2 = $consultainicial2 . $concatF1F2;
}
