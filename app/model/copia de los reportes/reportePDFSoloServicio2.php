...
//Reporte Turnos
//echo "select count(*) from auditoria where Estado != 'NORMAL' and auditoria.FechaLlegada  and auditoria.IdServicio = $idServicio and auditoria.FechaLlegada >= '$fechaInicial 00:00:00' and auditoria.FechaLlegada<='$fechafinal 23:59:59'";
//exit();
    ...
    <body class="cuerpo">
        ...
        <DIV class="BORDESOTROS">
            <div style="margin-top: 15px;">
                <div>Reporte generado del Servicio: <?php echo $nombreServicio1 ?></div>
            </div>
            <div class="divfechas">
